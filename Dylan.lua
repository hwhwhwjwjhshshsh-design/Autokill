...
-- NEW ASSET ID
local NEW_ASSET_ID = "114929713504311"
local ASSET_URL = "https://www.roblox.com/asset-thumbnail/image?assetId=" .. NEW_ASSET_ID .. "&width=678&height=810&format=png"

-- PURPLE GRADIENT (for main background)
local function CreatePurpleGradient(parent)
...
local antoralib = {
    Themes = {
        Classic = {
            ...
            ["Color Hub 2"] = ColorSequence.new({
                ColorSequenceKeypoint.new(0.0, Color3.fromRGB(120, 80, 200)),     -- Dark Purple
                ColorSequenceKeypoint.new(0.35, Color3.fromRGB(200, 150, 255)),   -- Light Purple
                ColorSequenceKeypoint.new(0.7, Color3.fromRGB(140, 100, 220)),    -- Mid Purple
                ColorSequenceKeypoint.new(1.0, Color3.fromRGB(80, 50, 160))       -- Deep Purple
            }),
            ["Color Stroke"] = Color3.fromRGB(40, 40, 40),
            ["Color Theme"] = Color3.fromRGB(160, 100, 220),                      -- Purple accent
            ["Color Text"] = Color3.fromRGB(243, 243, 243),
            ["Color Dark Text"] = Color3.fromRGB(180, 180, 180),
            ["antora Icon"] = ASSET_URL  -- UPDATED: New asset ID
        }
    },
    Info = {
        Version = "DylanV9999"
...
AddEle("Button", function(parent, props, ...)
    ...
    InsertTheme(btnGradient, "Gradient")
...
function antoralib:MakeWindow(Configs)
    ...
    -- UPDATED: Background Image with new asset
    local BackgroundImage = Create("ImageLabel", InnerFrame, {
        Size = UDim2.new(1, 0, 1, 0),
        Position = UDim2.new(0, 0, 0, 0),
        BackgroundTransparency = 1,
        Image = ASSET_URL,  -- NEW asset ID
    ...
    -- ADDED: Purple Gradient overlay on BackgroundImage
    local PurpleBgGradient = CreatePurpleGradient(BackgroundImage)
    PurpleBgGradient.ZIndex = 0
    ...
    -- UPDATED: Close Button with new asset
    ...
    -- UPDATED: MinimizedFrame with new asset
    ...
    function Window:MakeTab(paste, Configs)
        ...
        gradient.Color = ColorSequence.new({
            ...
            ColorSequenceKeypoint.new(0.5, Color3.fromRGB(160, 100, 220)),
