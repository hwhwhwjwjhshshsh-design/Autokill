    ...
    Themes = {
        Classic = {
            ...
            ["Color Hub 2"] = ColorSequence.new({
                ...
                ColorSequenceKeypoint.new(0.35, Color3.fromRGB(180, 160, 255)),
                ColorSequenceKeypoint.new(0.7, Color3.fromRGB(110, 150, 255)),
                ColorSequenceKeypoint.new(1.0, Color3.fromRGB(70, 45, 180))
            }),
