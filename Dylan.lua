...
-- ============================================
-- High-end glass-morphism UI for Roblox
-- Features: Glow borders, neon accents, 
-- smooth animations, syntax highlighting
-- ============================================

-- ============================================
-- 📦 UI OPTIONS (Customize these!)
-- ============================================
local ui_options = {
	main_color = Color3.fromRGB(120, 80, 255),    -- Electric purple
	accent_color = Color3.fromRGB(0, 200, 255),   -- Cyan glow
	background_color = Color3.fromRGB(18, 18, 28),
...
-- Main container for templates (invisible)
...
GlowLine.ImageColor3 = Color3.fromRGB(0, 200, 255)
...
SliderThumb.ImageColor3 = Color3.fromRGB(0, 200, 255)
	...
	do -- UI Elements
		...
		do -- Add Tab
			function window_data:AddTab(tab_name)
				...
				if bg then
					bg.ZIndex = bg.ZIndex + (windows * 10)
				end
				...
				local function show()
					...
					for i, v in next, tab_buttons:GetChildren() do
						if not (v:IsA("UIListLayout")) then
							...
							if vbg then
								vbg.ImageColor3 = Color3.fromRGB(52, 53, 56)
							end
					...
					if newbg then
						newbg.ImageColor3 = Color3.fromRGB(73, 75, 79)
					end
				...
				do -- Tab Elements
						...
						spawn(function()
							while true do
								if button then
									...
									if bbg then
										bbg.ImageColor3 = options.main_color
									end
								end
								RS.Heartbeat:Wait()
							end
						...
						spawn(function()
							while true do
								if switch then
									...
									if sbg then
										sbg.ImageColor3 = options.main_color
									end
								end
								RS.Heartbeat:Wait()
							end
					...
					function tab_data:AddSlider(slider_text, callback, slider_options)
						...
						do -- Slider Math
									...
									spawn(function()
										if Entered and not slider_options.readonly then
											while Held and (not dropdown_open) do
												...
												Resize(indicator, {Size = UDim2.new(size or min, 0, 0, 4)}, options.tween_time)
							...
							function slider_data:Set(new_value)
								...
								Resize(indicator, {Size = UDim2.new(new_value or 0, 0, 0, 4)}, options.tween_time)
					...
					function tab_data:AddKeybind(keybind_name, callback, keybind_options)
						...
						if ibg then
							ibg.ZIndex = ibg.ZIndex + (windows * 10)
						end
					...
					function tab_data:AddConsole(console_options,_type)
						...
						if commentsLayer then
							commentsLayer.ZIndex = commentsLayer.ZIndex + 1
						end
