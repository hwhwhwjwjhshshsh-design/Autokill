...
local function applyGradient(frame, rotation, transparency)
    local grad = Instance.new("UIGradient")
    grad.Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(120, 80, 200)),   -- Dark Purple
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(200, 150, 255)),  -- Light Purple
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(80, 50, 160))     -- Deep Purple
    })
    grad.Rotation = rotation or 45
    if transparency then
        grad.Transparency = NumberSequence.new({
            NumberSequenceKeypoint.new(0.00, transparency),
            NumberSequenceKeypoint.new(0.50, transparency * 0.5),
            NumberSequenceKeypoint.new(1.00, transparency)
        })
    end
    grad.Parent = frame
...
local function applyOverlay(parent, transparency, scaleType)
    ...
    overlay.Image = "rbxassetid://114929713504311"
    overlay.ImageTransparency = transparency or 0.7
    overlay.ScaleType = scaleType or Enum.ScaleType.Crop
    overlay.ZIndex = 0
    return overlay
end
...
function addDropdownSelect(p, p2, Multi, Callback, Value, List)
    ...
    applyGradient(DropdownValue, 45, 0.3)
    applyOverlay(DropdownValue, 0.9)
    ...
    applyGradient(DropdownSelect, 45, 0.2)
    applyOverlay(DropdownSelect, 0.85)
    ...
    applyGradient(Search_1, 90, 0.4)
    applyOverlay(Search_1, 0.9)
    ...
    applyGradient(Frame_3, 45, 0.3)
    applyOverlay(Frame_3, 0.9)
    ...
    ScrollingFrame_1.ScrollBarImageColor3 = Color3.fromRGB(200, 150, 255)
    ...
    function itemslist:Add(text)
        ...
        applyGradient(Item_1, 90, 0.3)
        applyOverlay(Item_1, 0.9)
...
function Library:Window(p)
    ...
    mainGrad.Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(120, 80, 200)),
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(200, 150, 255)),
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(80, 50, 160))
    })
    mainGrad.Rotation = 45
    mainGrad.Parent = Background_1
    
    -- MAIN OVERLAY
    local mainOverlay = Instance.new("ImageLabel")
    mainOverlay.Name = "BgOverlay"
    mainOverlay.Parent = Background_1
    mainOverlay.AnchorPoint = Vector2.new(0.5, 0.5)
    mainOverlay.Position = UDim2.new(0.5, 0, 0.5, 0)
    mainOverlay.Size = UDim2.new(1, 0, 1, 0)
    mainOverlay.BackgroundTransparency = 1
    mainOverlay.Image = "rbxassetid://114929713504311"
    mainOverlay.ImageTransparency = 0.7
    mainOverlay.ScaleType = Enum.ScaleType.Crop
    mainOverlay.ZIndex = 0
    ...
    applyGradient(Frame_5, 0, 0.3)
    applyOverlay(Frame_5, 0.9)
    ...
    Close_1.Image = "https://www.roblox.com/Thumbs/Asset.ashx?width=420&height=420&assetId=95673274595796"
    ...
    ChSize_1.Image = "https://www.roblox.com/Thumbs/Asset.ashx?width=420&height=420&assetId=95673274595796"
    ...
    DropdownValue_1.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    ...
    applyGradient(DropdownValue_1, 45, 0.3)
    applyOverlay(DropdownValue_1, 0.9)
    ...
    ScrollingFrame_2.ScrollBarImageColor3 = Color3.fromRGB(200, 150, 255)
    ...
    Select_1.BackgroundColor3 = Color3.fromRGB(200, 150, 255)
    ...
    function Tabs:Tab(p)
        ...
        applyGradient(InPage_1, 45, 0.3)
        applyOverlay(InPage_1, 0.9)
        ...
        delay(.1, function()
            if not Tabs.Value then
                local total = #Tabs.List
                local index = Tabs.DefaultIndex
        ...
        function Func:Toggle(p)
            ...
            applyGradient(Frame_1, 90, 0.2)
            applyOverlay(Frame_1, 0.9)
            UICorner_2.Parent = Frame_1
            UICorner_2.CornerRadius = UDim.new(1,0)
            
            Frame_2.Parent = Frame_1
            Frame_2.AnchorPoint = Vector2.new(0, 0.5)
            Frame_2.BackgroundColor3 = Color3.fromRGB(200, 150, 255)
            Frame_2.BorderColor3 = Color3.fromRGB(0,0,0)
            Frame_2.BorderSizePixel = 0
            Frame_2.Position = UDim2.new(0, 0,0.5, 0)
            Frame_2.Size = UDim2.new(0, 13,0, 13)
            applyGradient(Frame_2, 45, 0.1)
            applyOverlay(Frame_2, 0.9)
            
            if Value then
                Frame_2.BackgroundColor3 = Color3.fromRGB(200, 150, 255)
            else
                Frame_2.BackgroundColor3 = Color3.fromRGB(120, 80, 200)
            end
            ...
            local function change()
                ...
                if Value then
                    ...
                    tw({v = Frame_1, t = 0.15, s = Enum.EasingStyle.Linear, d = "Out", g = {BackgroundColor3 = Color3.fromRGB(200, 150, 255)}}):Play()
                    ...
                    tw({v = Frame_1, t = 0.15, s = Enum.EasingStyle.Linear, d = "Out", g = {BackgroundColor3 = Color3.fromRGB(120, 80, 200)}}):Play()
                    tw({v = Frame_2, t = 0.15, s = Enum.EasingStyle.Linear, d = "Out",
                        g = {
        ...
        function Func:Slider(p)
            ...
            FrameValueTextBox.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            ...
            applyGradient(FrameValueTextBox, 45, 0.2)
            applyOverlay(FrameValueTextBox, 0.9)
            ...
            Frame_3.BackgroundColor3 = Color3.fromRGB(200, 150, 255)
            Frame_3.BorderColor3 = Color3.fromRGB(0,0,0)
            Frame_3.BorderSizePixel = 0
            Frame_3.Position = UDim2.new(0, 0,0.5, 0)
            Frame_3.Size = UDim2.new(0, 0,1, 0)
            applyGradient(Frame_3, 90, 0.2)
            ...
            applyGradient(Frame_4, 45, 0.1)
            applyOverlay(Frame_4, 0.9)
        ...
        function Func:Code(p)
            ...
            applyGradient(Code, 45, 0.2)
            applyOverlay(Code, 0.85)
            ...
            applyGradient(F_1, 45, 0.2)
            applyOverlay(F_1, 0.85)
            ...
            UIGradient_1.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 255, 255)), ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 255, 255))}
        ...
        function Func:Keybind(p)
            ...
            ToggleValue_1.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            ...
            applyGradient(ToggleValue_1, 90, 0.2)
            applyOverlay(ToggleValue_1, 0.9)
            UICorner_1.Parent = ToggleValue_1
            UICorner_1.CornerRadius = UDim.new(1,0)
            
            Frame_1.Parent = ToggleValue_1
            Frame_1.AnchorPoint = Vector2.new(1, 0.5)
            Frame_1.BackgroundColor3 = Color3.fromRGB(200, 150, 255)
            Frame_1.BorderColor3 = Color3.fromRGB(0,0,0)
            Frame_1.BorderSizePixel = 0
            Frame_1.Position = UDim2.new(1, 0,0.5, 0)
            Frame_1.Size = UDim2.new(0, 13,0, 13)
            applyGradient(Frame_1, 45, 0.1)
            applyOverlay(Frame_1, 0.9)
            UICorner_2.Parent = Frame_1
            UICorner_2.CornerRadius = UDim.new(1,0)
            ...
            applyGradient(KeybindValue_1, 45, 0.2)
            applyOverlay(KeybindValue_1, 0.9)
            ...
            local function change()
                ...
                if Value then
                    Config:SetTextTransparencyTitle(0)
                    tw({v = ToggleValue_1, t = 0.15, s = Enum.EasingStyle.Linear, d = "Out", g = {BackgroundColor3 = Color3.fromRGB(200, 150, 255)}}):Play()
                    ...
                    Config:SetTextTransparencyTitle(0.7)
                    tw({v = ToggleValue_1, t = 0.15, s = Enum.EasingStyle.Linear, d = "Out", g = {BackgroundColor3 = Color3.fromRGB(120, 80, 200)}}):Play()
                    tw({v = Frame_1, t = 0.15, s = Enum.EasingStyle.Linear, d = "Out",
                        g = {
                            BackgroundColor3 = Color3.fromRGB(200, 150, 255),
                            AnchorPoint = Vector2.new(0, 0.5),
        ...
        function Func:ColorPicker(p)
            ...
            applyGradient(Picker_1, 45, 0.1)
            applyOverlay(Picker_1, 0.9)
            ...
            ColorpickBar.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            ...
            applyGradient(ColorpickBar, 45, 0.2)
            applyOverlay(ColorpickBar, 0.85)
            ...
            BarValueHax_1.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            ...
            applyGradient(BarValueHax_1, 90, 0.2)
            applyOverlay(BarValueHax_1, 0.9)
            ...
            BarValueRed_1.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            ...
            applyGradient(BarValueRed_1, 0, 0.2)
            applyOverlay(BarValueRed_1, 0.9)
            ...
            BarValueGreen_1.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            ...
            applyGradient(BarValueGreen_1, 0, 0.2)
            applyOverlay(BarValueGreen_1, 0.9)
            ...
            BarValueBlue_1.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            ...
            applyGradient(BarValueBlue_1, 0, 0.2)
            applyOverlay(BarValueBlue_1, 0.9)
    ...
    function Tabs:Notify(p)
        ...
        Background_1.ClipsDescendants = true
        Background_1.GroupTransparency = 1
        applyGradient(Background_1, 45, 0.2)
        applyOverlay(Background_1, 0.85)
    ...
    function Tabs:Dialog(p)
        ...
        applyGradient(Button1_1, 45, 0.2)
        applyOverlay(Button1_1, 0.85)
        ...
        applyGradient(Button2_1, 45, 0.2)
        applyOverlay(Button2_1, 0.85)
    ...
    do
        ...
        Size_1.BackgroundTransparency = 0
        ...
        Size_1.Image = "https://www.roblox.com/Thumbs/Asset.ashx?width=420&height=420&assetId=124681933147191"
        ...
        -- Theme dropdown (now just changes gradient colors if you want)
        local function CallTheme(v)
            -- This can be removed or repurposed
        end
        
        local ThemeDrop = addDropdownSelect(DropdownValue_1, DropdownValue_1, false, CallTheme, "Dark", {"Dark", "Amethyst"})
        ...
        do
            ...
            BackgroundCloseUI_1.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            ...
            applyGradient(BackgroundCloseUI_1, 45, 0.2)
            applyOverlay(BackgroundCloseUI_1, 0.85)
